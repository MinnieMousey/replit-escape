...
export const FIR_BOUNDARIES: FirBoundaryFeature[] = [
  // Piarco FIR (TTZP) — rebuilt from TT AIP ENR 2.1 corner points.
  // Closed ring covering Trinidad + eastern Caribbean ocean sector.
  {"ident":"TTZP","name":"Piarco","tier":"FIR","source":"TTZP-AIP","coordinates":[[[[-63.0,14.0],[-53.0,14.0],[-53.0,9.0],[-56.5,9.0],[-56.5,7.0],[-58.5,7.0],[-60.0,8.5],[-60.75,8.5],[-62.0,10.0],[-61.783333,10.733333],[-62.057778,10.085],[-61.927778,9.989722],[-61.465833,9.989722],[-59.95,8.916667],[-62.2,11.0],[-62.5,12.0],[-62.8,13.0],[-63.0,14.0]]]]},
